...
// inviter plugin
grails.plugin.inviter.demo.enabled=true
grails.plugin.inviter.test.enabled=true
grails.plugin.inviter.facebook.enabled=true
grails.plugin.inviter.facebook.key='197755966948551'
grails.plugin.inviter.facebook.secret='5dc5ace6405e5882511e6dd177aa5f77'
grails.plugin.inviter.yahoo.enabled=true
...
grails.plugin.inviter.windowslive.enabled=true
